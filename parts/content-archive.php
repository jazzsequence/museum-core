<?php if ( have_posts() ) : ?>
	...
	if ( is_category() ) {
	    ...
	    <h2 class="the_title"><?php esc_attr_e( sprintf( __( 'Posts filed under %s','museum-core'), $category ) ); ?></h2>
	...
	<?php /* If this is a tag archive */
		...
		<h2 class="the_title"><?php esc_attr_e( sprintf( __('Posts filed under %s','museum-core'), $tag_name ) ); ?></h2>

	<?php /* If this is a daily archive */
	} elseif ( is_day() ) { ?>
		<h2 class="the_title"><?php esc_attr_e( sprintf( __('Archive for %1$s','museum-core'), get_the_time('j F Y') ) ); ?></h2>

	<?php /* If this is a monthly archive */
	} elseif ( is_month() ) { ?>
		<h2 class="the_title"><?php esc_attr_e( sprintf( __('Archive for %1$s','museum-core'), get_the_time('F Y') ) ); ?></h2>

	<?php /* If this is a yearly archive */
	} elseif ( is_year() ) { ?>
		<h2 class="the_title"><?php esc_attr_e( sprintf( __('Archive for %1$s','museum-core'), get_the_time('Y') ) ); ?></h2>
